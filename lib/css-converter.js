...
const GROUPS = {
  ...
  style:        new Set(['background','color']),
  interactions: new Set(['display','cursor','transition','transform','opacity','overflow','visibility']),
};
...
class CSSConverter {
  ...
  _groupProps(props) {
    const top     = {};
    const buckets = { layout: {}, box: {}, typo: {}, style: {}, interactions: {} };
    const rest    = {};
